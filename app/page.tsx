  ...
  function robotDashboard() {
    ...
    return (
      <div className="robot-guide-dashboard glass-card">
        <div className="robot-avatar"><div className="bot mini"><span className="antenna a1"/><span className="antenna a2"/><b><span className="bot-eyes"><i/><i/></span><span className="bot-smile"/></b></div></div>
      ...
      {activeContent === "explore" && <>
        ...
        <section className="explorer" aria-label="AI knowledge explorer">
          ...
          <aside className="guide-column">
            <button type="button" className="guide-card glass-card clickable" onClick={() => setAskOpen(true)} aria-label={t.question}><div><span className="status-dot"/>{t.guide}<em>Beta</em></div><div className="bot"><span className="antenna a1"/><span className="antenna a2"/><b><span className="bot-eyes"><i/><i/></span><span className="bot-smile"/></b></div><p>{t.guideText}</p><span className="guide-cta">✦ {t.askChip} →</span></button>
